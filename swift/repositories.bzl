...
def swift_rules_dependencies():
    ...
    _maybe(
        ...
        urls = ["https://github.com/grpc/grpc-swift/archive/0.11.0.zip"],
        sha256 = "8e83eeffd26668193fdf083dfbaa35449c8b92d887dc8005847821e6b255fa4d",
        strip_prefix = "grpc-swift-0.11.0/",
        type = "zip",
