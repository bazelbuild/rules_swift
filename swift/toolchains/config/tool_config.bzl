...
def _tool_config_info_init(
    ...
    Args:
        ...
        driver_config: Special configuration for a Swift driver tool. This
            ...
            `swift-symbolgraph-extract`). It may also contain two optional
            entries: `swift_executable`, a custom Swift executable that may be
            provided by the toolchain; and `toolchain_root`, the root directory
            of a custom toolchain to use. This may not be specified if
