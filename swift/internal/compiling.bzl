...
def compile(
    ...
    Args:
        ...
        minimum_os_version: The minimum OS version that this target should be
            compiled for. If provided, supporting toolchains use this to create
            a versioned target triple for the `-target` flag.
