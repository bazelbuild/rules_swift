...
SwiftProtoImportInfo = provider(
    doc = """\
Provides a mapping of proto paths to module names derived from an aspect 
over the dependencies of the swift_proto_library targets.
""",
    fields = {
        "imports": """\
Depset of strings mapping proto paths to module names.
