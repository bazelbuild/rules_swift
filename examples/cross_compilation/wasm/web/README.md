...
bazel build //examples/cross_compilation/wasm:web_app

# Serve it and open http://localhost:8000 in a browser.
python3 -m http.server -d bazel-bin/examples/cross_compilation/wasm/web_app 8000
```
...
```sh
bazel build //examples/cross_compilation/wasm:Reactor.wasm
