...
def _custom_swift_proto_compile(ctx, target_label, swift_proto_compiler_info, additional_compiler_info, proto_infos, module_mappings):
    ...
    for proto_info in proto_infos:
        ...
        for proto_src in proto_info.check_deps_sources.to_list():
            ...
            swift_src_path = paths.join(target_label.name, base_swift_src_path)
