...
# FIXME: Actually parse the map and fix the paths relative to the original
# location, since it might not be the generated one. We can't use VFS overlay
# like SE-0403, so rewriting the modulemap is the only way.
sed 's|header "|header "../../|g' "$input" > "$output"
