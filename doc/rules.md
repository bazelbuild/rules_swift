...
| <a id="new_swift_proto_library-compilers"></a>compilers |  One or more `swift_proto_compiler` target (or a target producing `SwiftProtoCompilerInfo`), from which the Swift protos will be generated.   | <a href="https://bazel.build/concepts/labels">List of labels</a> | optional |  `["@rules_swift//proto/compilers:swift_proto"]`  |
